...
class YOLODetector:
    def __init__(self):
        ...
        # 获取模型路径参数
        weight_path = rospy.get_param('~weight_path', '/home/abot/kk_ws/src/Yolov8_ros/yolov8_ros/weights/abup.pt')
        ...
        # 获取图像话题参数
        image_topic = rospy.get_param('~image_topic', '/camera_front/image_raw')
    ...
    def image_callback(self, msg):
        ...
        if self.visualize:
            try:
                ...
                pass  # headless mode: no display available
